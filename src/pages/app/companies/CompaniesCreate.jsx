...
// //               />
// //               {errors.name && (
// //                 <p className="text-red-600 text-sm">Industry type is required</p>
// //               )}
// //             </div>
...
//   phone: yup.string().matches(/^[0-9+\-\s]{8,15}$/, "Enter a valid phone number").required("Phone is required"),
//   status: yup.string().required("Status is required"),
//   createdAt: yup.string().required("Created date is required"),
// });
...
//       description: "You can now see it in the companies list.",
//     });
...
//                 className="focus:ring-blue-400 focus:border-blue-400"
//               />
//               {errors.name && <p className="text-red-600 text-sm">Industry type is required</p>}
//             </div>
...
//                 className="focus:ring-blue-400 focus:border-blue-400"
//               />
//               {errors.createdAt && <p className="text-red-600 text-sm">{errors.createdAt.message}</p>}
//             </div>
//           </CardContent>
...
export default function CompaniesCreate() {
  ...
  const onSubmit = (formData) => {
    ...
    reset();
    navigate("/companies"); // ✅ Navigate to companies page
  };
  ...
  return (
    <div className="max-w-xl mx-auto py-10">
      <Card className="shadow-md border rounded-xl bg-white">
        <CardHeader>
          <CardTitle className="text-xl text-gray-800">Add New Company</CardTitle>
        </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                className="focus:ring-blue-400 focus:border-blue-400"
              />
              {errors.industryType && <p className="text-red-600 text-sm">{errors.industryType.message}</p>}
            </div>
